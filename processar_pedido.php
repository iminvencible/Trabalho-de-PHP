...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $cliente_nome = isset($_POST['cliente_nome']) ? htmlspecialchars($_POST['cliente_nome']) : 'Nâo informado';
 
    $produto1_nome = isset($_POST['produto1_nome']) ? htmlspecialchars($_POST['produto1_nome']) : 'Produto 1';
    $produto1_valor = isset($_POST['produto1_valor']) ? (float)$_POST['produto1_nome'] : '0.0';
    $produto2_nome = isset($_POST['produto2_nome']) ? htmlspecialchars($_POST['produto2_nome']) : 'Produto 2';
    $produto2_valor = isset($_POST['produto2_valor']) ? (float)$_POST['produto2_nome'] : '0.0';
